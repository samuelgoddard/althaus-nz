      ...
      <div className="pt-12 pb-6 md:pt-20 xl:pt-24 md:pb-5 bg-purple">
        <div className="container lg:px-32">
          ...
          <div className="w-full flex flex-wrap items-center py-6 pb-2">
            ...
            <small className="text-white md:ml-auto text-sm w-full text-left md:w-auto md:text-right block mt-5 md:mt-0">&copy; Althaus. All rights reserved {(new Date().getFullYear())}</small>
          </div>
